...
### 2. Explicación y Casos de Uso por Utilidad en Fonoaudiología

#### Las 5 utilidades del documento (enfocadas en EFR):
...
1. **Estudiar mecanismos fisiológicos**
   ...
   *   *Caso de uso:* Un fonoaudiólogo investigador quiere averiguar exactamente de qué manera el daño exclusivo en una conexión nerviosa (sinapsis) afecta el envío de la señal eléctrica al cerebro, un aislamiento que sería imposible o antiético de realizar en un paciente humano vivo.
...
4. **Optimizar parámetros de estímulo**
   ...
   *   *Caso de uso:* Configurar el modelo para reproducir miles de pitidos con diferentes modulaciones hasta encontrar el diseño de estímulo que consiga "despertar" la lectura eléctrica (EFR) más fuerte y nítida. Una vez hallado, los fonoaudiólogos pueden empezar a usar ese sonido específico en los equipos de sus consultorios.
...
### 3. En conclusión: ¿Para qué sirve el modelo de Verhulst (2018) en fonoaudiología?

El artículo (*A cochlear epiphenomenon or auditory nerve feature? Evaluating Envelope Following Responses (EFRs) in simulations and human listeners* / *Computational modeling of the human auditory periphery...*) establece a este modelo como un **simulador biológicamente informado de la vía auditiva periférica**. 
